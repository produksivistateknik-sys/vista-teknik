...
// Cari posisi hideTooltip closing
const marker = "if(tip)(tip as HTMLElement).style.display=\"none\";\r\n  };\n}";
const idx = content.indexOf(marker);
console.log('marker found at:', idx);

// Potong sebelum closing }, tambah return block
...
const result = before + returnBlock;
fs.writeFileSync('src/App.tsx', result, 'utf8');
console.log('✅ Return block ditambahkan!');
console.log('Total chars:', result.length);
console.log('SIDEBAR_MENUS.map:', result.includes('SIDEBAR_MENUS.map'));
console.log('erp-content:', result.includes('erp-content'));
console.log('Last 30:', JSON.stringify(result.slice(-30)));