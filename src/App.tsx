...
﻿function ActivityLogView({activityLog}){
  ...
  const stats=[
    ...
    {l:"Hari Ini",v:activityLog.filter(a=>a.created_at?.startsWith(todayStr)).length,c:"#10b981"},
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:8,marginBottom:12}}>
        {stats.map((s,i)=>(
          <div key={i} style={{background:"#fff",border:"1px solid #eaecf0",borderRadius:7,padding:"10px 12px",borderLeft:"3px solid "+s.c}}>
            ...
            <div style={{fontSize:9,color:"#94a3b8",marginTop:3,fontWeight:600,textTransform:"uppercase",letterSpacing:.3}}>{s.l}</div>
          </div>
        ))}
      </div>
