...
export const DIVISI_PROSES = {
  mekanik:    ["POTONG","BENDING","STEL","FINISHING"],
...
export const KOMPONEN_PROSES_MAP: Record<string, string[]> = {
  ...
  "F3B.9": ["POTONG","BENDING","STEL","FINISHING","RENDAM","PAINTING","RAKIT","PASANG KOMPONEN","WIRING CONTROL"],
  ...
  "F3B.12": ["POTONG","STEL","FINISHING","RENDAM","PAINTING","RAKIT"],
