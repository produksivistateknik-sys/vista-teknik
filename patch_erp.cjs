...
console.log('Total baris awal:', lines.length);

// Cari batas yang tepat
...
console.log('Start (monitorTabs):', startLine);
console.log('End (KendalaInbox):', endLine);
...
result.slice(-5).forEach((l,i) => console.log(result.length-5+i, ':', l));
