...
# Cari batas fungsi MasterPekerja
import re
...
NEW_MASTER_PEKERJA = r"""function MasterPekerja({pekerja,setPekerja,createPekerja,updatePekerja,removePekerja,logActivity,log,user}){
...
print("🔄 Replace MasterPekerja...")
s, e = find_function_bounds(content, "MasterPekerja")
if s == -1:
    print("❌ MasterPekerja tidak ditemukan!")
    exit(1)
print(f"   Ditemukan karakter {s}–{e}")
content = content[:s] + NEW_MASTER_PEKERJA + content[e:]
