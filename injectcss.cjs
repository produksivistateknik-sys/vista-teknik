...
console.log('✅ CSS ERP berhasil diinjeksi!');
console.log('Verifikasi erp-sidebar:', fixed.includes('erp-sidebar{'));
console.log('Verifikasi erp-main:', fixed.includes('erp-main{'));